...
mongoose
  .connect(
    "mongodb+srv://ketak2022:wWmuP3gRpErZAHe2@sb-foods.8144mqt.mongodb.net/SBF?retryWrites=true&w=majority&appName=SB-Foods",
    {
  ...
  .then(() => {
    ...
    app.get(
      "/fetch-food-items-by-menu-category/:menuCategory",
      async (req, res) => {
        try {
