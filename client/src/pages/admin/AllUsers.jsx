...
const AllUsers = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get('https://sb-foods-5t36.onrender.com/fetch-users');
  ...
  const deleteUser = async (userId) => {
    if (window.confirm('Are you sure you want to delete this user?')) {
      ...
      try {
        ...
        const response = await axios.put('https://sb-foods-5t36.onrender.com/delete-user', { id: userId });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://sb-foods-5t36.onrender.com/register', formData);
