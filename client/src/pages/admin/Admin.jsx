...
const Admin = () => {
  ...
  const fetchUsers = async() =>{
    await axios.get('https://sb-foods-5t36.onrender.com/fetch-users').then(
      (response)=>{
  ...
  const approveUser = async(id) =>{
    await axios.post('https://sb-foods-5t36.onrender.com/approve-user', {id}).then(
      (response)=>{
  ...
  const rejectUser = async(id) =>{
    await axios.post('https://sb-foods-5t36.onrender.com/reject-user', {id}).then(
      (response)=>{
  ...
  const handlePromoteUpdate = async() =>{
    await axios.post('https://sb-foods-5t36.onrender.com/update-promote-list', {promoteList}).then(
      (response) =>{
