...
const Home = () => {
  ...
  const fetchRestaurants = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_BASE_API_URL}/fetch-restaurants`);
    ...
    <div className="HomePage">
      ...
      <div className="home-categories-container">
        {[
          ...
          <div className="home-category-card" key={category.name} onClick={() => navigate(`/category/${category.name}`)}>
