...
const RestaurantHome = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      setError(null);
      try {
        const response = await axios.get(`https://sb-foods-5t36.onrender.com/fetch-user-details/${userId}`);
  ...
  useEffect(() => {
    const fetchRestaurantData = async () => {
      ...
      try {
        const response = await axios.get(`https://sb-foods-5t36.onrender.com/fetch-restaurant-details/${userId}`);
    ...
    const fetchCounts = async () => {
      try {
        ...
        const [itemsResponse, ordersResponse] = await Promise.all([
          axios.get('https://sb-foods-5t36.onrender.com/fetch-items'),
          axios.get('https://sb-foods-5t36.onrender.com/fetch-orders')
        ]);
