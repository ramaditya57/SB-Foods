...
const EditProduct = () => {
  ...
  const fetchMenuCategories = async () => {
    ...
    try {
      const { data } = await axios.get(`${BASE_URL}/fetch-categories`);
  ...
  const fetchCuisines = async () => {
    try {
      const { data } = await axios.get(`${BASE_URL}/fetch-cuisines`);
  ...
  const fetchRestaurant = async () => {
    try {
      const { data } = await axios.get(`${BASE_URL}/fetch-restaurant-details/${userId}`);
      setRestaurant(data);
    } catch (err) {
      console.error(err);
    }
  ...
  const fetchItem = async () => {
    try {
      const { data } = await axios.get(`${BASE_URL}/fetch-item-details/${id}`);
  ...
  const handleUpdateItem = async () => {
    ...
    try {
      await axios.put(`${BASE_URL}/update-product/${id}`, {
