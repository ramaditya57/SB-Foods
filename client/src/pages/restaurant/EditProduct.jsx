...
const EditProduct = () => {
  ...
  const fetchItem = async () => {
    try {
      const { data } = await axios.get(`https://sb-foods-5t36.onrender.com/fetch-item-details/${id}`);
  ...
  const handleUpdateItem = async () => {
    ...
    try {
      await axios.put(`https://sb-foods-5t36.onrender.com/update-product/${id}`, {
  ...
  const handleDeleteItem = async () => {
    ...
    try {
      await axios.delete(`https://sb-foods-5t36.onrender.com/delete-product/${id}`);
