...
const RestaurantOrders = () => {
  ...
  const fetchRestaurantAndOrders = async() => {
    ...
    try {
      ...
      const restaurantResponse = await axios.get(`https://sb-foods-5t36.onrender.com/fetch-restaurant-details/${userId}`);
      ...
      const ordersResponse = await axios.get('https://sb-foods-5t36.onrender.com/fetch-orders');
  ...
  const cancelOrder = async(id) => {
    try {
      await axios.put('https://sb-foods-5t36.onrender.com/cancel-order', {id});
  ...
  const updateOrderStatus = async(id) => {
    ...
    try {
      await axios.put('https://sb-foods-5t36.onrender.com/update-order-status', {
        id, 
