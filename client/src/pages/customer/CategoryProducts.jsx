...
const CategoryProducts = () => {
  ...
  const fetchRestaurantsWithMenuCategory = async () => {
    ...
    try {
      ...
      const foodItemsResponse = await axios.get(`https://sb-foods-5t36.onrender.com/fetch-food-items-by-menu-category/${category}`);
      ...
      if (foodItemsResponse.data && foodItemsResponse.data.length > 0) {
        ...
        const restaurantsResponse = await axios.get('https://sb-foods-5t36.onrender.com/fetch-restaurants');
